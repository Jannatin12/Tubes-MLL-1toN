...
int main() {
  ...
  while (pilihan != 0) {
    ...
    cout << "7.  Hapus Kamar" << endl;
    cout << "8.  Total Kamar Hotel" << endl;
    cout << "9.  Jumlah Kamar Yang Tersedia" << endl;
    cout << "10. Jumlah Pengunjung" << endl;
    cout << "0.  Exit" << endl;
    cout << "Pilihan Menu: ";
    cin >> pilihan;
    ...
    switch (pilihan) {
        ...
        case 7: {
          showKamar(L); // show parent aja
          adr_kamar p;
          cout << "Masukkan Nomor Kamar: ";
          cin >> nomor;
          p = searchNomorKamar(L, nomor);
          deleteKamar(L, p);
          cout << "Kamar Berhasil Dihapus" << endl << endl;
          break;
        }
        case 8: {
          cout << "Total Kamar Hotel: " << totalKamar(L) << endl << endl;
          break;
        }
        case 9: {
          cout << "Jumlah Kamar yang Tersedia : " << jumlahKamarTersedia(L) << endl
               << endl;
          break;
        }
        case 10: {
          cout << "Total Pengunjung Saat Ini : " << totalPengunjung(L) << endl
               << endl;
          break;
        }
    }
